...
const locationBodies={
  ...
  ghetto:`<rect width="640" height="112" fill="url(#stars)"/><path d="M0 85h74V35h76v50h39V8h127v77h52V43h108v42h43V24h121v276H0z" fill="${C.black}"/>${windows(204,30,5,3,C.orange,20,19)}${windows(383,59,4,2,C.cyan,20,18)}<rect y="178" width="640" height="122" fill="${C.ink}"/><path d="M0 247h640" stroke="${C.blue}" stroke-width="3" stroke-dasharray="17 12"/><path d="M80 86h151v92H80z" fill="${C.brick}" stroke="${C.cream}" stroke-width="3"/><path d="M95 158l29-35 28 16 30-43 34 62" fill="none" stroke="${C.green}" stroke-width="9"/><path d="M520 69v135M486 70h67" stroke="${C.gray}" stroke-width="7"/><rect x="489" y="61" width="24" height="18" fill="${C.gold}"/>`,
